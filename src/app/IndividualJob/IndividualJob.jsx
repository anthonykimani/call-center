  ...
  return (
    <div className="">
      ...
      <section className="lg:px-[100px] px-[10px] py-[50px] bg-[#F7F3ED] font-circular-light">
        <span>
          <h3 onClick={()=>handleReturn()} className=" cursor-pointer flex items-center my-[20px]"><i className='bx bx-chevron-left bx-sm'></i> Back to Jobs Page</h3>
          <article>
            <div className="bg-white xsm:p-10">
              <div
                data-aos="zoom-in"
                data-aos-duration="3"
                className="pt-4 px-2  rounded-lg flex flex-col justify-around "
              >
                ...
                <hr />
                <div className="flex flex-col xl:flex-row justify-around px-4">
