  ...
  return (
    <section className=" bg-service-bg bg-cover bg-top md:p-20">
      <main className="flex flex-col items-center text-center mb-10">
        <h1 data-aos="fade-up" data-aos-duration="500" className=" font-extrabold text-4xl my-[30px]">Services</h1>
      ...
      <article data-aos="fade-up" data-aos-duration="1500" className="flex overflow-x-scroll hide-scroll-bar p-5">
