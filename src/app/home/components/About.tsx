  ...
  return (
    <main>
      <h1
        ...
        className="text-3xl md:text-4xl font-bold mb-[20px] text-[#060640] flex justify-center"
      >
        About us
      </h1>
      <div className="flex flex-col md:flex-row-reverse md:items-start p-2 max-w-[1280px]">
        <Image
          data-aos="fade-up"
