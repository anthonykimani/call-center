...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row-reverse md:items-start p-2">
      <Image data-aos="fade-up" data-aos-duration="500" src={AboutImg} alt="nexus-logo" className="w-full md:w-[50%]" />
      <article className="flex flex-col justify-around md:justify-between p-2 md:p-10">
        <h1 data-aos="fade-up" data-aos-duration="1000" className="text-3xl md:text-4xl font-bold mb-[20px] text-[#060640]">
          About us
        </h1>
        <h2 data-aos="fade-up" data-aos-duration="1500" className="text-base mb-[20px]">
        ...
        <div data-aos="fade-up" data-aos-duration="2000" className="flex flex-col">
